...
"
"nmap <C-_>s :cs find s <C-R>=expand("<cword>")<cr><cr> :cw<cr>  "查找C代码符号
"
"nmap <C-_>g :cs find g <C-R>=expand("<cword>")<cr><cr> :cw<cr>  "查找本定义
"
"nmap <C-_>c :cs find c <C-R>=expand("<cword>")<cr><cr> :cw<cr>   "查找调用本函数的函数
"
...
"
"nmap <C-_>d :cs find d <C-R>=expand("<cword>")<cr><cr> :cw<cr>  " 查找本函数调用函数
""
"
"
""
